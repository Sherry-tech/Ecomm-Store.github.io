...
const ProductCartInCheckout = ({ p }) => {
    ...
    //changing/updating color data in local-storage & dispatch to redux
    ...
    //changing/updating quantity data in local-storage & dispatch to redux
    ...
    return(
            <tbody>
                <tr>
                    ...
                    <td>{p.brand}</td>
                    <td>
                        <select name="color" className="form-control" onChange={handleColorChange}>
