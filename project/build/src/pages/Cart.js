...
//if array of cart [] have two items one with price 100 and other with price 200 so that function will give us the total count of 300
    const getTotal = () => {
 ...
 //saving to the backend Data-Base    
    const saveOrderToDb = () => {
